 ...
 *   - tipo_contacto_enum: paciente, familiar, cuidador, otro, no_informa
 *
...
export const TIPO_CONTACTO_OPTIONS = [
...
export const TIPO_CONTACTO_VALUES = TIPO_CONTACTO_OPTIONS.map((o) => o.value)
